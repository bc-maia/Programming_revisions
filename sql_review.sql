...
GRANT INSERT, SELECT, UPDATE, DELETE ON test3.*
TO 'studentweb'@'127.0.0.1'
IDENTIFIED BY 'turtledove';


--in terminal enter 'mysql' to use db via terminal
--to list avaiable databases enter 'show databases;'
...
Don't include multiple values in one cell. Ex. You shouldn't create a cell named jobs and then give it the value: McDonalds, Radio Shack, Walmart,â�¦ Normalized Tables
